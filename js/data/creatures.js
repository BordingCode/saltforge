...
export const CREATURES_BY_BAND = { 1: [], 2: [], 3: [], 4: [] };
for (const c of CREATURE_DEFS)
    CREATURES_BY_BAND[c.band].push(c);
...
export const CREATURE_SHAPE = Object.fromEntries(CREATURE_DEFS.map((c) => [c.defId, c.shape]));
export const CREATURE_ACCENT = Object.fromEntries(CREATURE_DEFS.map((c) => [c.defId, c.accent]));
